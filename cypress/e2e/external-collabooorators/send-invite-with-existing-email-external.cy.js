describe('My First Test', () => {
    it('click on alert',()=>{
       ...
       //  cy.get('.fluid > input').type('{backspace}');
        ...
        cy.get(':nth-child(3) > :nth-child(1) > .field > .ui > input').type('Alina')
        cy.get(':nth-child(3) > :nth-child(2) > .field > .ui > input').type('Joy')
        cy.get(':nth-child(2) > :nth-child(2) > .field > .ui > input').type('zoha+1171@hucu.ai')
